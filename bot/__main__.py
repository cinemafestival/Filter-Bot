...
PM_START_TEXT = """
*Hello* *{}*
*My name is* *{}*\n\n`😔 Sorry Bruh, I can also be used in Cinema Festival Disscuss!`
...
if START_IMG is None:
    img = "https://telegra.ph/Cinema-Festival-02-18-2"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="♻️ Group",url="https://t.me/joinchat/T_yIME8RMB-AO9Xx"),InlineKeyboardButton(text="🏆 Channel",url="https://t.me/joinchat/Rh44PcxBE6HYusJ1")]]
